...
if (isset($_POST['simpan'])) {
    ...
    if (isset($_POST['id'])) {
        ...
        $simpan = mysqli_query($conn, "UPDATE article 
                                        SET 
                                        judul = '$judul',
                                        isi = '$isi',
                                        gambar = '$gambar',
        ...
        //insert data
        $simpan = mysqli_query($conn, "INSERT INTO article (judul,isi,gambar,tanggal,username)
...
if (isset($_POST['hapus'])) {
    ...
    //hapus data
    $hapus = mysqli_query($conn, "DELETE FROM article WHERE id = '$id'");
