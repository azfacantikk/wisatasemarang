                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    if ($row["gambar"] != '') {
                                        if (file_exists('image/' . $row["gambar"] . '')) {
                                            echo '<br><img src="image/' . $row["gambar"] . '" class="img-fluid" style="max-width: 100px;" alt="Gambar Gallery">';
                                        }
                                    }
                                    ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="formGroupExampleInput" class="form-label">Yakin akan menghapus gallery
